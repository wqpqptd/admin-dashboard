...
const DrivingSchool: React.FC = () => {
    ...
    const handleNumberProfiles = (examinations, packageItems) => {
        const examFuture = examinations.filter(exam => new Date(exam.examinationsDate) > new Date()).sort((a,b) => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <CardDataStats title="Tổng số đợt sát hạch" total={examinations.length}  levelUp>
          {/* <svg
