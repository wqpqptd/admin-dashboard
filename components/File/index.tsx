                                ...
                                <tr key={packageItem?.id}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p className="text-black dark:text-white">
                                            <Link className="mb-5.5 pt-3 inline-block hover:text-primary" href={`/profileManager/file/${packageItem?.id}`}>
                                                {packageItem?.name}
                                            </Link>
                                        </p>
                                    </td>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div className="flex items-center space-x-3.5">
                                            ...
                                            <button onClick={() => deleteFile(packageItem?.id)} className="hover:text-primary">
                                                <svg
                                                    className="fill-current"
                                                    width="18"
                                                    height="18"
