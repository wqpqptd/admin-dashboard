                ...
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <form onSubmit={handleSubmit((data) => console.log(data))}>
                        ...
                        <div className="p-6.5">
                            ...
                            <div className="mb-4.5">
                                <SelectProvinces label="Tinh thanh pho" value={packageItem.province}/>
                            </div>
                            <div className="mb-4.5">
                                <SelectDistricts label="Quan huyen" provinceName={packageItem.province} value={packageItem.district}/>
                            </div>
                            <div className="mb-4.5">
                                <SelectWards label="Xa phuong" provinceName={packageItem.province} districtName={packageItem.district} value={packageItem.wards}/>
                            </div>
                            <div className="mb-4.5">
                                <label className="mb-2.5 block text-black dark:text-white">
                                    Tôn giáo:
