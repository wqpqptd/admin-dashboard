...
const FileDetail = () => {
    ...
    useEffect(() => {
        axios.get(`${URL_SERVER}/profiledetail`)
            .then(response => {
    ...
    const deleteFileDetail = (fileId:any) => {
        axios.delete(`${URL_SERVER}/profiledetail/${fileId}`)
            .then(response => {
                console.log(`Deleted with ID ${fileId}`, response.data);
                            ...
                            <tr key={packageItem?.id}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center space-x-3.5">
                                        <Link href={`fileDetail/update?id=${packageItem?.id}`}>
